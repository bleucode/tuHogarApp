...
def signup():
    ...
    if request.method == 'GET':
        ...
        msg.body = 'Por favor verifica tu cuenta para poder usar TuHogarApp. Haz click aqui. http://localhost:7000/email-verif'
        mail.send(msg)
...
def envio():
    msg = Message('TuHogarApp', sender='azulvs15@gmail.com', recipients=[username])
    msg.body = 'Por favor verifica tu cuenta para poder usar TuHogarApp. Haz click aqui. http://localhost/email-verif'
    mail.send(msg)
    return render_template("email.html")"""
